...
public: \
	DECLARE_CLASS(UAnimGraphNode_PoseHandler, UAnimGraphNode_AssetPlayerBase, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/AnimGraph"), ANIMGRAPH_API) \
...
private: \
	...
	UAnimGraphNode_PoseHandler(const UAnimGraphNode_PoseHandler&); \
public: \
...
template<> ANIMGRAPH_API UClass* StaticClass<class UAnimGraphNode_PoseHandler>();
