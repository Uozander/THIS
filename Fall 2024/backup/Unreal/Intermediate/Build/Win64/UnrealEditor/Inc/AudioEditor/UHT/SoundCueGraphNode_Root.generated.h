...
public: \
	DECLARE_CLASS(USoundCueGraphNode_Root, USoundCueGraphNode_Base, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AudioEditor"), AUDIOEDITOR_API) \
...
private: \
	...
	USoundCueGraphNode_Root(const USoundCueGraphNode_Root&); \
public: \
...
template<> AUDIOEDITOR_API UClass* StaticClass<class USoundCueGraphNode_Root>();
