...
#define FID_Engine_Source_Developer_AutomationController_Public_IAutomationReport_h_45_GENERATED_BODY \
...
#define FOREACH_ENUM_ECOMPARISONFILETYPES(op) \
	op(EComparisonFileTypes::Unapproved) \
	op(EComparisonFileTypes::Approved) \
	op(EComparisonFileTypes::Difference) 

enum class EComparisonFileTypes : uint8;
template<> struct TIsUEnumClass<EComparisonFileTypes> { enum { Value = true }; };
