...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestEnumStruct>();
...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestSimpleStruct>();
...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestKey>();
...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestComplexArray>();
...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestSimpleMap>();
...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestSimpleKeyComplexValueMap>();
...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestComplexMap>();
...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestSimpleSet>();
...
template<> EDITORCONFIG_API UScriptStruct* StaticStruct<struct FEditorConfigTestComplexSet>();
...
public: \
	DECLARE_CLASS(UEditorConfigTestObject, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/EditorConfig"), NO_API) \
...
private: \
	...
	UEditorConfigTestObject(const UEditorConfigTestObject&); \
public: \
...
template<> EDITORCONFIG_API UClass* StaticClass<class UEditorConfigTestObject>();
