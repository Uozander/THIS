...
template<> PROPERTYEDITOR_API UScriptStruct* StaticStruct<struct FDetailsSectionSelection>();
...
template<> PROPERTYEDITOR_API UScriptStruct* StaticStruct<struct FDetailsViewConfig>();
...
public: \
	DECLARE_CLASS(UDetailsConfig, UEditorConfigBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/PropertyEditor"), NO_API) \
...
private: \
	...
	UDetailsConfig(const UDetailsConfig&); \
public: \
...
template<> PROPERTYEDITOR_API UClass* StaticClass<class UDetailsConfig>();
