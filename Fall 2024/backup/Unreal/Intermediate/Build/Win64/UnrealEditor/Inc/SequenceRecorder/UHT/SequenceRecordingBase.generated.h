...
public: \
	DECLARE_CLASS(USequenceRecordingBase, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/SequenceRecorder"), NO_API) \
...
#define FID_Engine_Source_Editor_SequenceRecorder_Public_SequenceRecordingBase_h_17_ENHANCED_CONSTRUCTORS \
	...
	NO_API USequenceRecordingBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	USequenceRecordingBase(USequenceRecordingBase&&); \
	USequenceRecordingBase(const USequenceRecordingBase&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, USequenceRecordingBase); \
	...
	NO_API virtual ~USequenceRecordingBase();
...
template<> SEQUENCERECORDER_API UClass* StaticClass<class USequenceRecordingBase>();
