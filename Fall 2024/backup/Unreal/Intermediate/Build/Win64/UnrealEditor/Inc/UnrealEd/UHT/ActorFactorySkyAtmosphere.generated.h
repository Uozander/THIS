...
public: \
	DECLARE_CLASS(UActorFactorySkyAtmosphere, UActorFactory, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/UnrealEd"), UNREALED_API) \
...
private: \
	...
	UActorFactorySkyAtmosphere(const UActorFactorySkyAtmosphere&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UActorFactorySkyAtmosphere>();
