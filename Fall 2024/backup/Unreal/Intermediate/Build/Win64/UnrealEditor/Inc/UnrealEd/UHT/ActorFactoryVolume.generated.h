...
public: \
	DECLARE_CLASS(UActorFactoryVolume, UActorFactory, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/UnrealEd"), UNREALED_API) \
...
private: \
	...
	UActorFactoryVolume(const UActorFactoryVolume&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UActorFactoryVolume>();
