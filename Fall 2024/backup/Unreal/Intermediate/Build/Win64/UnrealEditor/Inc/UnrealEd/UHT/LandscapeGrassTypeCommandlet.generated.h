...
public: \
	DECLARE_CLASS(ULandscapeGrassTypeCommandlet, UCommandlet, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	...
	ULandscapeGrassTypeCommandlet(const ULandscapeGrassTypeCommandlet&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class ULandscapeGrassTypeCommandlet>();
