...
template<> UNREALED_API UScriptStruct* StaticStruct<struct FPropertyEditTestTextStruct>();
...
template<> UNREALED_API UScriptStruct* StaticStruct<struct FPropertyEditorTestEditCondition>();
...
public: \
	DECLARE_CLASS(UPropertyEditorTestInstancedObject, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	...
	UPropertyEditorTestInstancedObject(UPropertyEditorTestInstancedObject&&); \
	UPropertyEditorTestInstancedObject(const UPropertyEditorTestInstancedObject&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UPropertyEditorTestInstancedObject>();
...
public: \
	DECLARE_CLASS(UFirstDerivedPropertyEditorTestObject, UPropertyEditorTestInstancedObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UFirstDerivedPropertyEditorTestObject(UFirstDerivedPropertyEditorTestObject&&); \
	UFirstDerivedPropertyEditorTestObject(const UFirstDerivedPropertyEditorTestObject&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UFirstDerivedPropertyEditorTestObject>();
...
public: \
	DECLARE_CLASS(USecondDerivedPropertyEditorTestObject, UPropertyEditorTestInstancedObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	USecondDerivedPropertyEditorTestObject(USecondDerivedPropertyEditorTestObject&&); \
	USecondDerivedPropertyEditorTestObject(const USecondDerivedPropertyEditorTestObject&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class USecondDerivedPropertyEditorTestObject>();
...
template<> UNREALED_API UScriptStruct* StaticStruct<struct FPropertyEditorTestInstancedStruct>();
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UPropertyEditorTestObject(UPropertyEditorTestObject&&); \
	UPropertyEditorTestObject(const UPropertyEditorTestObject&); \
public: \
...
public: \
	DECLARE_CLASS(UHideCategoriesBase, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UHideCategoriesBase(UHideCategoriesBase&&); \
	UHideCategoriesBase(const UHideCategoriesBase&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UHideCategoriesBase>();
...
public: \
	DECLARE_CLASS(UShowCategoriesTest, UHideCategoriesBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UShowCategoriesTest(UShowCategoriesTest&&); \
	UShowCategoriesTest(const UShowCategoriesTest&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UShowCategoriesTest>();
...
public: \
	DECLARE_CLASS(UBlueprintPropertyTestObject, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UBlueprintPropertyTestObject(UBlueprintPropertyTestObject&&); \
	UBlueprintPropertyTestObject(const UBlueprintPropertyTestObject&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UBlueprintPropertyTestObject>();
...
public: \
	DECLARE_CLASS(UBlueprintPropertyContainerTestObject, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UBlueprintPropertyContainerTestObject(UBlueprintPropertyContainerTestObject&&); \
	UBlueprintPropertyContainerTestObject(const UBlueprintPropertyContainerTestObject&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UBlueprintPropertyContainerTestObject>();
...
public: \
	DECLARE_CLASS(UTestSparseClassDataBase, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UTestSparseClassDataBase(UTestSparseClassDataBase&&); \
	UTestSparseClassDataBase(const UTestSparseClassDataBase&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UTestSparseClassDataBase>();
...
public: \
	DECLARE_CLASS(UTestSparseClassData, UTestSparseClassDataBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UTestSparseClassData(UTestSparseClassData&&); \
	UTestSparseClassData(const UTestSparseClassData&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UTestSparseClassData>();
...
template<> UNREALED_API UScriptStruct* StaticStruct<struct FTestSparseClassDataStorage>();
...
public: \
	DECLARE_CLASS(APropertyEditorTestActor, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	APropertyEditorTestActor(APropertyEditorTestActor&&); \
	APropertyEditorTestActor(const APropertyEditorTestActor&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class APropertyEditorTestActor>();
...
public: \
	DECLARE_CLASS(UPropertyEditorRowGeneratorTest, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), NO_API) \
...
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UPropertyEditorRowGeneratorTest(UPropertyEditorRowGeneratorTest&&); \
	UPropertyEditorRowGeneratorTest(const UPropertyEditorRowGeneratorTest&); \
public: \
...
template<> UNREALED_API UClass* StaticClass<class UPropertyEditorRowGeneratorTest>();
...
template<> UNREALED_API UEnum* StaticEnum<EPropertyEditorTestEnum>();
...
template<> UNREALED_API UEnum* StaticEnum<EPropertyEditorTestBitflags>();
...
template<> UNREALED_API UEnum* StaticEnum<EPropertyEditorTestEditColor>();
...
template<> UNREALED_API UEnum* StaticEnum<EPropertyEditorTestUnderscores>();
...
template<> UNREALED_API UEnum* StaticEnum<ETestEnumFlags>();
