...
public: \
	DECLARE_CLASS(UVREditorAssetContainer, UDataAsset, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/VREditor"), NO_API) \
...
#define FID_Engine_Source_Editor_VREditor_Public_VREditorAssetContainer_h_24_ENHANCED_CONSTRUCTORS \
	...
	NO_API UVREditorAssetContainer(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UVREditorAssetContainer(UVREditorAssetContainer&&); \
	UVREditorAssetContainer(const UVREditorAssetContainer&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UVREditorAssetContainer); \
	...
	NO_API virtual ~UVREditorAssetContainer();
...
template<> VREDITOR_API UClass* StaticClass<class UVREditorAssetContainer>();
