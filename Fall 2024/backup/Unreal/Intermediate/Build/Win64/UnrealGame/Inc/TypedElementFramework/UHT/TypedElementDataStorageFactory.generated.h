...
private: \
	static void StaticRegisterNativesUTypedElementDataStorageFactory(); \
	friend struct Z_Construct_UClass_UTypedElementDataStorageFactory_Statics; \
public: \
	DECLARE_CLASS(UTypedElementDataStorageFactory, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/TypedElementFramework"), TYPEDELEMENTFRAMEWORK_API) \
	DECLARE_SERIALIZER(UTypedElementDataStorageFactory)
...
#define FID_Engine_Source_Runtime_TypedElementFramework_Public_Elements_Interfaces_TypedElementDataStorageFactory_h_18_ENHANCED_CONSTRUCTORS \
	...
	TYPEDELEMENTFRAMEWORK_API UTypedElementDataStorageFactory(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UTypedElementDataStorageFactory(UTypedElementDataStorageFactory&&); \
	UTypedElementDataStorageFactory(const UTypedElementDataStorageFactory&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(TYPEDELEMENTFRAMEWORK_API, UTypedElementDataStorageFactory); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UTypedElementDataStorageFactory); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UTypedElementDataStorageFactory)
...
template<> TYPEDELEMENTFRAMEWORK_API UClass* StaticClass<class UTypedElementDataStorageFactory>();
